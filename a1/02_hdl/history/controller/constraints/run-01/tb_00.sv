...
module controller_tb;
  ...
  task automatic check_legal(
    ...
    begin
      InstrD = instr;
      #1;
      // For legal instructions, every output port is fully specified and checked.
  ...
  task automatic check_illegal(
    ...
    begin
      InstrD = instr;
      #1;
      // On illegal instructions, only specified side-effect suppression is checked,
      // while non-side-effect outputs are intentionally not constrained.
  ...
  initial begin
    ...
    // Load class: all defined funct3 variants, including zero offset and sign-boundary immediates.
    ...
    // Store class: all defined funct3 variants plus fragmented immediate corners.
    ...
    // Branch class: all defined funct3 variants and illegal encodings, with fragmented immediates.
    ...
    // I-type ALU: all operation classes, legal shifts, and illegal shift-immediate encodings.
    ...
    // R-type ALU: all funct3 classes, legal funct7 combinations, strict illegality otherwise.
    ...
    // Unsupported/extension/system opcodes explicitly illegal by spec.
    ...
    // Additional unknown opcodes / corners.
